...
insert into game (id, id_steam, name_game, img_url_game) values (nextval('game_id_seq'), 440, 'Warframe', 'https://steamcdn-a.akamaihd.net/steam/apps/230410/header.jpg?t=1576268096');
...
insert into game_sessions (game_idx, session_idx) values (1,2);
